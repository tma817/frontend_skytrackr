		...
		<>
			...
			<div className="text-center">
				...
				<p className="mt-1.5 text-xs text-gray-400 tracking-wide">
					Start tracking flights & prices for free
				</p>
			</div>
				...
				<div className="group">
					...
					<div className="relative">
						<input
							...
							className="w-full border rounded-xl p-3 bg-transparent text-sm text-gray-900 placeholder:text-gray-300 focus:border-sky-400 focus:outline-none transition-colors duration-200 pr-10"
						/>
						<button
							type="button"
