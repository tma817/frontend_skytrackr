    ...
    useEffect(() => {
        async function fetchTicketDetail() {
            ...
            try {
                ...
                const data = await res.json();
				console.log(data)
                // Giả định backend đã trả về đúng cấu trúc FlightResult mới của bạn
                setFlight(data);
            } catch (error) {
                console.error("Error fetching ticket:", error);
            } finally {
    ...
    if (!flight) {
        return (
            <main className="min-h-screen flex flex-col items-center justify-center">
                ...
                <button onClick={goBackToSearch} className="mt-4 text-cyan-600 font-bold">Back</button>
            </main>
        );
    }
                ...
                <div className="grid grid-cols-12 gap-8">
                            ...
                            <div key={itIdx} className="rounded-2xl border bg-white p-8 shadow-sm">
                                ...
                                <div className="mt-8 flex items-center justify-between">
                                    <div className="text-left">
                                        ...
                                        <p className="text-xs text-slate-400">{itinerary.departure.date}</p>
                                    </div>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-slate-400">{itinerary.arrival.date}</p>
                                    </div>
                                </div>
                                            ...
                                            <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-5">
                                                <div className="grid grid-cols-3 items-center">
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-[10px] text-slate-500 font-bold uppercase">{segment.carrierCode}{segment.flightNumber}</p>
                                                    </div>
                                                    <div className="text-right">
                                                ...
                                                <div className="mt-4 flex justify-between items-center text-[11px] text-slate-500 border-t pt-3">
                                                    ...
                                                    {segment.departure.terminal && <span>Terminal: <b>{segment.departure.terminal}</b></span>}
                                                </div>
                                            </div>
                                            {segment.layover && (
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="sticky top-8 rounded-2xl border bg-white p-6 shadow-sm">
                            ...
                            <div className="mt-4 flex items-end justify-between border-b pb-6">
                                <div>
                                    <p className="text-xs text-slate-500">Total Price ({pax} Pax)</p>
                                    <p className="text-4xl font-black tracking-tighter text-cyan-700">
                                        {flight.price.amount.toLocaleString()}{" "}
                                        <span className="text-lg font-bold">{flight.price.currency}</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="py-6 space-y-4">
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-bold">{flight.baggage.checked} Piece(s)</span>
                                </div>
                            </div>
