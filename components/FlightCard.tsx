...
import { FlightResult, FlightItinerary } from "../src/types/flight";
    ...
    return (
        ...
        >
            <div className="flex flex-col md:flex-row">
                {/* Left Side: Itineraries (Outbound & Inbound) */}
                <div className="flex-1 p-5 space-y-6 border-b md:border-b-0 md:border-r border-slate-100">
                    ...
                    {/* Vòng lặp hiển thị từng hành trình (Đi/Về) */}
                ...
                <div className="bg-slate-50/50 p-6 flex flex-col justify-center items-center min-w-[200px]">
                    ...
                    <button className="mt-6 w-full flex items-center justify-center gap-2 rounded-xl bg-black px-6 py-3 text-sm font-bold text-white transition-all hover:opacity-90 active:scale-95 shadow-lg">
                        Select
        ...
        <div className="flex items-center gap-6">
            ...
            <div className="flex-1 flex flex-col items-center">
                ...
                <div className="flex w-full items-center gap-2">
                    ...
                    <div className="relative h-px flex-1 border-t-2 border-dashed border-slate-200">
                        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-1">
                            <svg className={`h-3 w-3 text-slate-300 ${itinerary.type === 'inbound' ? 'rotate-[270deg]' : 'rotate-90'}`} fill="currentColor" viewBox="0 0 24 24">
                                <path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z" />
                            </svg>
                        </div>
                    </div>
